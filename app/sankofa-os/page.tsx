...
const softwareJsonLd = {
  ...
  description:
    'Sankofa OS is clinical memory infrastructure for healthcare organizations. Unlike traditional EHRs designed for billing, Sankofa OS is built to remember patient context, track care plan adherence, detect clinical drift, and surface what matters at the point of care.',
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Sankofa OS addresses healthcare\'s continuity crisis. Patients are forced to repeat their stories at every visit because systems don\'t remember context. Care plans drift without detection. Physicians spend more time on documentation than patient care.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Sankofa OS is currently in development. Sankofa Family Medicine is building an early access cohort of physicians, medical directors, and health systems who want to influence the product roadmap.',
      },
    },
    {
      '@type': 'Question',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Sankofa OS - Clinical Memory Infrastructure',
      },
    ],
  },
  twitter: {
        ...
        <main id="main-content">
          ...
          >
            ...
            <div className="absolute inset-0" aria-hidden="true">
              ...
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-[radial-gradient(ellipse_at_top,_rgba(188,152,51,0.12)_0%,_transparent_70%)]" />
              <div
            ...
            <div className="relative max-w-4xl mx-auto text-center">
              ...
              <h1
                id="hero-heading"
                className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-white mb-8 tracking-tight leading-[0.95]"
              >
                Your EHR remembers
                <br />
          ...
          {/* The Problem */}
          <section className="relative py-32 px-6" aria-labelledby="problem-heading">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                ...
                <div className="lg:col-span-7 lg:pt-12">
                  <div className="space-y-6 text-white/60 text-lg leading-relaxed">
                    ...
                    <p>
                      The cost is measured in hundreds of billions annually. The human
                      cost is immeasurable.
                    </p>
                    <p className="text-white/40 text-base pt-4 border-t border-white/10">
                      The infrastructure to solve this exists. It simply hasn&apos;t been
                      built for the right purpose.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {/* The Solution */}
          <section className="relative py-32 px-6" aria-labelledby="solution-heading">
            <div
          ...
          >
            ...
            <div className="relative max-w-2xl mx-auto text-center">
              ...
              <p className="text-white/50 text-lg mb-12 leading-relaxed">
                We&apos;re building our founding cohort of physicians who want clinical
