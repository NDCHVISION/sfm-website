  ...
  <div className="absolute inset-0 bg-black/40" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-32">
          <div className="max-w-2xl">
            ...
            <h1 className="font-display text-5xl md:text-6xl lg:text-7xl text-white mb-6 animate-fade-in delay-100">
              Medicine That<br />Remembers<span className="tm">™</span>
            </h1>
            
            <p className="text-xl text-white/90 mb-10 leading-relaxed animate-fade-in delay-200">
              Premium virtual primary care built on continuity, precision, and legacy. 
              One physician who knows your history. Every visit. HIPAA-compliant telehealth.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                description: 'Direct messaging with your physician. Responses within 24-48 hours, often sooner.',
              },
              {
                icon: Shield,
              ...
              <div key={promise.title} className="promise-card">
                <promise.icon className="w-8 h-8 text-sfm-azure mb-4" strokeWidth={1.5} aria-hidden="true" />
      ...
      <section className="py-24 bg-sfm-cream">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <p className="text-sfm-gold text-sm tracking-[0.2em] uppercase mb-4">The Sankofa Principle</p>
              ...
              <div className="space-y-6 text-muted leading-relaxed">
                ...
                <p>
                  In medicine, this translates to something radical: a clinic that actually remembers you. 
                  Your history, your context, your goals: retained with intention, not lost in the shuffle.
                </p>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              <p className="text-sfm-azure text-sm tracking-[0.2em] uppercase mb-4">Our Care</p>
              <h2 className="font-display text-4xl text-sfm-navy mb-6">
                Precision Medicine,<br />Personal Relationship
              </h2>
              <div className="divider-gold mb-8" />
              ...
              <ul className="space-y-4 mb-8">
                {[
                  ...
                  <li key={item} className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-sfm-gold rounded-full flex-shrink-0" aria-hidden="true" />
      ...
      <section className="py-24 bg-sfm-navy">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          />
          <p className="text-sfm-gold text-sm tracking-[0.2em] uppercase mb-4">Founder&apos;s Message</p>
          <blockquote className="font-display text-2xl md:text-3xl text-white italic leading-relaxed mb-6">
            ...
            care that remembers your history, respects your time, and stays with you across the years. 
            Many clinicians share these values; this practice gives us the structure and time to honor them.&quot;
          </blockquote>
