      ...
      <section className="relative pt-32 pb-20 bg-sfm-navy">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-white/80 text-lg max-w-xl mx-auto mb-6">
            Family Physician â€¢ Washington State
          </p>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-6 text-muted leading-relaxed">
            <p>
              Dr. Yaw Nkrumah is a family physician, founder of Sankofa Family Medicineâ„¢, and Founder & CEO 
              of The Nkrumah Doctrine Cultural Holdings (NDCHâ„¢), a cultural-systems and applied-AI studio.
            </p>
            <p>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-8">
            ...
            <div className="border border-gray-100 p-6 hover:border-sfm-azure/30 transition-colors">
              <p className="text-sfm-azure text-xs tracking-wide uppercase mb-2">COVID-19 Therapeutics â€¢ First Author</p>
            ...
            {/* MÃ©niÃ¨re Disease Publication */}
            <div className="border border-gray-100 p-6 hover:border-sfm-azure/30 transition-colors">
              <p className="text-sfm-azure text-xs tracking-wide uppercase mb-2">MÃ©niÃ¨re Disease Research</p>
              <h3 className="font-display text-xl text-sfm-navy mb-2">
                Pathogenesis and Etiology of MÃ©niÃ¨re Disease: A Scoping Review
              </h3>
