  ...
  const tiers = [
    {
      ...
      featured: false,
      highlights: ['Next-day appointments', '48-hour messaging', '30-min follow-ups'],
      features: [
        ...
        '2 comprehensive wellness visits/year',
        'Care coordination & referrals',
        'Prescription management',
        'Wholesale labs (70-90% savings)',
      ],
    ...
    },
    {
      ...
      featured: true,
      highlights: ['Priority scheduling', '24-hour messaging', '45-min visits'],
      features: [
        'Everything in Continuity Care',
        'Comprehensive DNA panel ($400 value)',
        'Physician-led genetic interpretation',
        'Pharmacogenomic medication guidance',
        'AI-generated health roadmap',
        '24-hour message response',
        'Priority scheduling',
        'Extended 45-minute follow-ups',
      ],
    ...
    },
    {
      ...
      features: [
        ...
        'Extended 60-minute visits',
        '4 wellness visits per year',
        'Family health planning',
        'After-hours urgent availability',
      ],
      notIncluded: [],
  ...
  const structuredData = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: 'Dr. Nkrumah',
        description: 'Board Certified family medicine physician specializing in genetics-informed virtual primary care',
