...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Clinical Services | Sankofa Family Medicine',
    description:
    ...
    images: [
      {
        url: 'https://sankofafamilymedicine.com/images/sfm-og-services.png',
        width: 1200,
        height: 630,
        alt: 'Sankofa Family Medicine Clinical Services - Virtual Primary Care in Washington State',
      },
    ],
  },
  twitter: {
    ...
    images: ['https://sankofafamilymedicine.com/images/sfm-og-services.png'],
  },
  robots: {
    index: true,
    follow: true,
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="space-y-6">
              {primaryServices.map((service, index) => (
                <article
                  key={service.id}
                  className="bg-white rounded-2xl border-l-4 border-sfm-gold shadow-sm overflow-hidden transition-all duration-200 hover:-translate-y-1 hover:shadow-xl"
                >
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                      ...
                      <div className="lg:w-1/3">
                        <div className="flex items-center gap-4 mb-3">
                          <div className="w-12 h-12 rounded-full bg-sfm-gold/10 flex items-center justify-center">
                            <service.icon
                          ...
                          <div>
                            <span className="text-sfm-azure text-xs tracking-wider uppercase">
                              {String(index + 1).padStart(2, '0')}
                            </span>
                            <h3 className="service-category-title font-display text-xl text-sfm-navy">
                              {service.category}
                            </h3>
                          </div>
                        </div>
                        <p className="text-muted italic pl-16">{service.tagline}</p>
                      </div>
                ...
                >
                  ...
                  <ul className="list-none space-y-2">
                    {service.items.map((item) => (
                      ...
                      >
                        <div
                          className="w-1.5 h-1.5 rounded-full bg-sfm-gold mt-1.5 flex-shrink-0"
                          aria-hidden="true"
                        />
                        {item}
                      </li>
        ...
        >
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2
              ...
              className="font-display text-4xl text-sfm-navy mb-4"
            >
              Experience Medicine That Remembers
            </h2>
            <p className="text-muted text-lg mb-10 max-w-2xl mx-auto">
              Join our founding member cohort and receive Tier 3 Executive benefits
              at Tier 2 Complete pricing, locked for life. Limited to 30 members.
            </p>
